...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'PBX Manager',                                        // App Name
    appTitle    : 'PBX Manager', // App Title
    appLogoImage: 'https://portal.htgsoft.com/media/khang-nguyen-xuan/HTG_Logo.png?_t=1655867586',                  // App Logo
  },
  layout: {
